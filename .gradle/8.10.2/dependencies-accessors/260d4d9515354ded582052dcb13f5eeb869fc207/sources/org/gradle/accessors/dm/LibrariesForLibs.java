...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final OpenidLibraryAccessors laccForOpenidLibraryAccessors = new OpenidLibraryAccessors(owner);
    private final ProtobufLibraryAccessors laccForProtobufLibraryAccessors = new ProtobufLibraryAccessors(owner);
    private final TfliteLibraryAccessors laccForTfliteLibraryAccessors = new TfliteLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>richtext</b> with <b>com.halilibo.compose-richtext:richtext-ui-material3</b> coordinates and
     * with version reference <b>richtext</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getRichtext() {
        return create("richtext");
    }
    ...
    /**
     * Group of libraries at <b>openid</b>
     */
    public OpenidLibraryAccessors getOpenid() {
        return laccForOpenidLibraryAccessors;
    }
    ...
    /**
     * Group of libraries at <b>tflite</b>
     */
    public TfliteLibraryAccessors getTflite() {
        return laccForTfliteLibraryAccessors;
    }
    ...
    public static class MaterialLibraryAccessors extends SubDependencyFactory {
        private final MaterialIconLibraryAccessors laccForMaterialIconLibraryAccessors = new MaterialIconLibraryAccessors(owner);

        public MaterialLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>material.icon</b>
         */
        public MaterialIconLibraryAccessors getIcon() {
            return laccForMaterialIconLibraryAccessors;
        }

    }

    public static class MaterialIconLibraryAccessors extends SubDependencyFactory {

        public MaterialIconLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>extended</b> with <b>androidx.compose.material:material-icons-extended</b> coordinates and
         * with version reference <b>materialIconExtended</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getExtended() {
            return create("material.icon.extended");
        }
    ...
    public static class MediapipeTasksLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>genai</b> with <b>com.google.mediapipe:tasks-genai</b> coordinates and
         * with version reference <b>mediapipeTasksGenai</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGenai() {
            return create("mediapipe.tasks.genai");
        }

        /**
         * Dependency provider for <b>imagegen</b> with <b>com.google.mediapipe:tasks-vision-image-generator</b> coordinates and
         * with version reference <b>mediapipeTasksImageGenerator</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getImagegen() {
            return create("mediapipe.tasks.imagegen");
        }

        /**
         * Dependency provider for <b>text</b> with <b>com.google.mediapipe:tasks-text</b> coordinates and
         * with version reference <b>mediapipeTasksText</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getText() {
            return create("mediapipe.tasks.text");
        }

    }

    public static class OpenidLibraryAccessors extends SubDependencyFactory {

        public OpenidLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>appauth</b> with <b>net.openid:appauth</b> coordinates and
         * with version reference <b>netOpenidAppauth</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAppauth() {
            return create("openid.appauth");
        }
    ...
    public static class TfliteLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public TfliteLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>tflite</b> with <b>com.google.android.gms:play-services-tflite-java</b> coordinates and
         * with version reference <b>playServicesTfliteJava</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("tflite");
        }

        /**
         * Dependency provider for <b>gpu</b> with <b>com.google.android.gms:play-services-tflite-gpu</b> coordinates and
         * with version reference <b>playServicesTfliteGpu</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getGpu() {
            return create("tflite.gpu");
        }

        /**
         * Dependency provider for <b>support</b> with <b>com.google.android.gms:play-services-tflite-support</b> coordinates and
         * with version reference <b>playServicesTfliteJava</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSupport() {
            return create("tflite.support");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>commonmark</b> with value <b>1.0.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>lifecycleProcess</b> with value <b>2.8.7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>materialIconExtended</b> with value <b>1.7.8</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMaterialIconExtended() { return getVersion("materialIconExtended"); }

        /**
         * Version alias <b>mediapipeTasksGenai</b> with value <b>0.10.25</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMediapipeTasksGenai() { return getVersion("mediapipeTasksGenai"); }

        /**
         * Version alias <b>mediapipeTasksImageGenerator</b> with value <b>0.10.21</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMediapipeTasksImageGenerator() { return getVersion("mediapipeTasksImageGenerator"); }

        /**
         * Version alias <b>mediapipeTasksText</b> with value <b>0.10.21</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMediapipeTasksText() { return getVersion("mediapipeTasksText"); }
        ...
        /**
         * Version alias <b>netOpenidAppauth</b> with value <b>0.11.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNetOpenidAppauth() { return getVersion("netOpenidAppauth"); }

        /**
         * Version alias <b>playServicesTfliteGpu</b> with value <b>16.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesTfliteGpu() { return getVersion("playServicesTfliteGpu"); }

        /**
         * Version alias <b>playServicesTfliteJava</b> with value <b>16.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesTfliteJava() { return getVersion("playServicesTfliteJava"); }

        /**
         * Version alias <b>protobuf</b> with value <b>0.9.5</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>richtext</b> with value <b>1.0.0-alpha02</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>serializationPlugin</b> with value <b>2.0.21</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSerializationPlugin() { return getVersion("serializationPlugin"); }

        /**
         * Version alias <b>splashscreen</b> with value <b>1.2.0-beta01</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class HiltPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>hilt.application</b> with plugin id <b>com.google.dagger.hilt.android</b> and
         * with version reference <b>hilt</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getApplication() { return createPlugin("hilt.application"); }
    ...
    public static class KotlinPluginAccessors extends PluginFactory {
         ...
         * with version reference <b>serializationPlugin</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
